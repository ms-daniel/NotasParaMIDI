...
int main()
{
    char nomeArq[100], arqOut[100];

    cout << "Digite o nome do arquivo + a extensao. Ex: teste.txt" << endl << "Obs: arquivo precisa estar na mesma pasta do app" << endl;
    cin >> nomeArq;

    cout << "\nDigite o nome para o arquivo de saida: ";
    cin >> arqOut;
...
int TransformaEmAscii(char nomeArq[], char arqSaida[]){
    ...
    arqOut.open(strcat(arqSaida, ".txt"), ios::trunc);
    ...
    cout << "\nTranscricao completa!" << endl;
    cout << "Salvo em /" << arqSaida << endl;
